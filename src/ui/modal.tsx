...
export const Modal = ({isOpen, title, children, onCancel, onConfirm, confirmText}: Props) => {
    ...
    const setModalOpen = (open: boolean) => {
        ...
        // @ts-ignore
        const overlayController = window.HSOverlay
        if (overlayController) {
            if (open) {
                overlayController.open(modalRef.current)
            } else {
                overlayController.close(modalRef.current)
            }
        }
    }
